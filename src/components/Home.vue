...
<template>
  <header class="header-area" :class="isSidebar ? 'header-area' : 'xl:!w-[calc(100%-73px)] xl:!ml-[73px]'">
    <div class="header-left">
      ...
      <div class="logo text-center h-[80px] xl:!hidden !flex items-center justify-center">
        <router-link to="/">
          <img class="inline-block w-[80px] hidden dark:block" src="/assets/img/logo/funding-talents.png" alt="logo">
          <img class="inline-block w-[80px] block dark:hidden" src="/assets/img/logo/logo-dark.png" alt="logo">
        </router-link>
      </div>
    </div>
        ...
        <transition
          ...
          <div
            ...
            <ul>
              ...
              <li class="group">
                <router-link to="/home" class="flex items-center text-[#4A485F] text-[18px] leading-[1.5] tracking-[-0.05px] py-[10px] transition-all duration-350 ease-linear group-hover:text-primary dark:text-white dark:group-hover:text-primary">
                  <svg class="w-[22px] h-[22px] mr-[10px] fill-[#4A485F] transition-all duration-350 ease-linear group-hover:!fill-primary dark:fill-white dark:group-hover:!fill-primary" focusable="false" viewBox="0 0 24 24" aria-hidden="true">
  ...
  <aside class="sidebar" :class="[isSidebar ? 'sidebar' : 'sidebar-toggle xl:!w-[73px]', isMenubar ? '!left-0' : '']">
    <div class="logo text-center h-[150px] flex items-center justify-center">
      <router-link to="/">
        <img class="inline-block w-[100px]" src="/assets/img/logo/funding-talents.png" alt="logo">
      </router-link>
    </div>
                    ...
                    <div class="account-info">
                      ...
                      <div class="account-info-bottom mt-[40px]">
                        ...
                        <div class="flex md:flex-nowrap flex-wrap items-center md:gap-[40px] gap-[20px]">
                          <p><span class="text-[16px] font-bold">Start Date:</span> Mar 11, 2023</p>
                          <p><span class="text-[16px] font-bold">End Date:</span> Apr 11, 2023</p>
          ...
          <div class="xl:w-3/12 w-full px-[15px]">
            <div class="card-wrap text-center">
              ...
              <div class="content">
                ...
                <h4 class="text-dark text-[15px] font-medium leading-[1.167] tracking-[-0.05px] dark:text-white">Prop Manager</h4>
                <div class="flex flex-wrap items-center px-[16px] py-[18px] rounded-[6px] mt-[15px] bg-white">
                  ...
                  <span class="flex-1 break-all text-[14px] text-dark text-left">@ryan Prop Dashboard</span>
                </div>
              </div>
            </div>
          </div>
